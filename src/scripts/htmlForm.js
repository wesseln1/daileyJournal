...
const mainPageHTML = {
  buildMyForm: () => {
    ...
    let flexContainer = htmlBuilder.createElementWithText(
      "div",
      undefined,
      "flex-container",
      "flexContainer"
    );
    let flexContainer2 = htmlBuilder.createElementWithText(
      "div",
      undefined,
      "flex-container2",
      "flexContainer2"
    ...
    let h1 = htmlBuilder.createElementWithText(
      "h1",
      "Journal Entry",
      undefined,
      "text-in-focus"
    ...
    let formDiv = htmlBuilder.createElementWithText(
      "div",
      undefined,
      "formDiv"
    );
    ...
    let dateLabel = htmlBuilder.createElementWithText(
      "label",
      "Date of Entry",
      "date-label",
      "dateLabel"
    );
    let conceptLabel = htmlBuilder.createElementWithText(
      "label",
      "Concepts Covered",
      "concept-lebel",
      "conceptLabel"
    );
    let entryLabel = htmlBuilder.createElementWithText(
      "label",
      "Journal Entry",
      "entry-label",
      "entryLabel"
    );
    let moodLabel = htmlBuilder.createElementWithText(
      "label",
      "Mood",
      "mood-label",
      "moodLabel"
    ...
    let dateInput = htmlBuilder.createElementWithText(
      "input",
      undefined,
      "date-input",
      "form-control",
    ...
    let conceptInput = htmlBuilder.createElementWithText(
      "input",
      undefined,
      "concept-input",
      "form-control",
    ...
    let entryInput = htmlBuilder.createElementWithText(
      "input",
      undefined,
      "entry-input",
      "form-control",
    ...
    let moodSelect = htmlBuilder.createElementWithText(
      "select",
      undefined,
      "mood-select",
      "btn",
    ...
    let moodOption = htmlBuilder.createElementWithText(
      "option",
      "How do you feel?",
      undefined,
      undefined,
    ...
    let moodOption1 = htmlBuilder.createElementWithText(
      "option",
      "Happy",
      undefined,
      undefined,
    ...
    let moodOption2 = htmlBuilder.createElementWithText(
      "option",
      "Exstaticed",
      undefined,
      undefined,
    ...
    let moodOption3 = htmlBuilder.createElementWithText(
      "option",
      "Sad",
      undefined,
      undefined,
    ...
    let moodOption4 = htmlBuilder.createElementWithText(
      "option",
      "Satisfied",
      undefined,
      undefined,
    ...
    let moodOption5 = htmlBuilder.createElementWithText(
      "option",
      "Grumpy",
      undefined,
      undefined,
    ...
    let moodOption6 = htmlBuilder.createElementWithText(
      "option",
      "Hangrey",
      undefined,
      undefined,
    ...
    let moodOption7 = htmlBuilder.createElementWithText(
      "option",
      "Sleepy",
      undefined,
      undefined,
    ...
    let moodOption8 = htmlBuilder.createElementWithText(
      "option",
      "Pissed Off",
      undefined,
      undefined,
    ...
    let saveEntryButton = htmlBuilder.createElementWithText(
      "button",
      "Record Entry",
      "entry-btn",
      "entryButton",
